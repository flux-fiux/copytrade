  ...
  return (
    <div className="px-3 py-3">
      <div className="flex items-center justify-between mb-3">
        <span className="text-xs font-medium text-muted-foreground uppercase tracking-wide">{t("sentiment_title")}</span>
      ...
      {loading ? (
        ...
        <div className="text-xs text-muted-foreground text-center py-2">{t("sentiment_nodata")}</div>
      ) : (
        <>
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-semibold text-emerald-400 w-10">{t("sentiment_long")}</span>
            ...
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-semibold text-red-400 w-10">{t("sentiment_short")}</span>
              <div className="flex-1 h-2.5 bg-muted rounded-full overflow-hidden">
                <div
          ...
          <div className="mt-2.5 flex items-center justify-between">
            <span className="text-[10px] text-muted-foreground">
              {t("sentiment_signals", { count: data.total_signals, hours: data.period_hours })}
            </span>
          </div>

          <div className="mt-1">
            <span className="text-[9px] text-muted-foreground/60">{t("sentiment_footer")}</span>
          </div>
        </>
      )}
    </div>
