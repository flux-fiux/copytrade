...
export const metadata = { title: "Terms of Service — ArbMind" };

const SECTIONS: { h: string; p: string }[] = [
  { h: "1. Acceptance of Terms", p: "By accessing ArbMind you agree to these Terms. If you do not agree, do not use the platform." },
  { h: "2. Nature of the Service", p: "ArbMind is a technology platform that lets users follow and automatically copy the trades of signal providers ('Masters'). We are not a broker, financial adviser, or asset manager and do not provide investment advice." },
  ...
  { h: "7. Limitation of Liability", p: "To the maximum extent permitted by law, ArbMind is not liable for trading losses or for indirect, incidental or consequential damages." },
